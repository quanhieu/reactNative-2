...
export default class MainComponent extends Component {
    static navigationOptions = ({ navigation }) => {
        ...
        let headerTitle = 'Main Page';
        let headerTitleAlign = "center";
        let headerTitleStyle = { color: 'white' };
        let headerStyle = { backgroundColor: '#f4511e' };
        ...
        return { headerTitle, headerTitleAlign, headerStyle, headerTitleStyle, headerRight, headerBackTitle };
    }
